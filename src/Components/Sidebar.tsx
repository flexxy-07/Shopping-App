  ...
  useEffect(() => {
   ...
   fetchCategory();
    ...
    const handleMinPriceChange = (e : React.ChangeEvent<HTMLInputElement>) => {
     ...
     setMinPrice(val ? parseFloat(val) : undefined);
    }
          ...
          <div className='mb-5 mt-4'>
            <h2 className="text-xl font-semibold mb-3">
              ...
              <div>
                ...
                <button
                  key={index}
                  className='block mb-2 px-3 py-2 w-full text-left border rounded hover:bg-blue-200 cursor-pointer'
            ...
            <button className='w-full mb-[4rem] py-2 bg-black text-white rounded mt-5 hover:cursor-pointer'
